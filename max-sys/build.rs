...
fn build_bindings(support_dir: &str) {
    ...
    let enums = [
        ...
        //jitter
        "t_jit_attr_flags",
        "t_jit_matrix_info_flags",
        "t_matrix_conv_info_flags",
        "t_jit_error_code",
        "t_jit_gl_mesh_cache_type",
        "t_jit_gl_chunk_flags",
        "t_jit_gl_layer",
        "t_jit_gl_animator_priority",
        "t_jit_anim_ui_priority",
        "t_jit_ob3d_flags",
        "t_jit_gl_view_key",
        "t_jit_gl_context_flag",
        "t_jit_gl_target_type",
        "t_jit_gl_view_status",
        "t_jit_gl_pf_target",
        "t_jit_gl_pf_pixeltype",
        "t_jit_gl_pf_flag",
        "t_jit_gl_target",
        "t_jit_gl_flag",
        "t_jit_window_flag",
        "t_jit_window_constants",
        "t_max_jit_mop_flag",
        "e_buffer_data_flag",
        "e_view_tag",
        "e_jit_state",
